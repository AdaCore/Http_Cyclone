...
package Tcp_Type with SPARK_Mode is
   ...
   TCP_MAX_SYN_QUEUE_SIZE : constant Syn_Queue_Size_Max :=
   ...
   TCP_DEFAULT_SYN_QUEUE_SIZE : constant Syn_Queue_Size :=
   ...
   function Tcp_Syn_Queue_Item_Model
      ...
      (Queue = null or else (Is_Initialized_Ip (Queue.Src_Addr) and then
