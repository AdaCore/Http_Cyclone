...
\subsection{CycloneTCP library organisation}
    ...
    The CycloneTCP library is TCP/IP stack that implements network protocols. It is particularly well adapted to embedded
    platforms and microcontrolers. As a result, the code is written to compile on those platforms and to be used with different
    real time OS, like for intance FreeRTOS.
